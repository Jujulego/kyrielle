...
export function once$(...args: [Observable, Partial<Observer>] | [Listenable, string, Partial<Observer>]): Unsubscribable {
  ...
  if (typeof args[1] === 'string') {
    ...
    const [observable, observer] = args as [Observable, Partial<Observer>];
