...
import { DataKey, DataMap, Key, Listenable, Listener, Observable, OffFn } from '../defs/index.js';
 ...
 * @param opts
 */
export function once$<M extends DataMap, K extends DataKey<M>>(source: Listenable<M>, key: K, listener: Listener<M[K]>, opts?: OnceOpts): OffFn;
